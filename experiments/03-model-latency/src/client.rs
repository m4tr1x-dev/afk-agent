...
//!
//! The same file as `experiments/02-vision-encoder/src/client.rs`, copied
//! rather than shared. Two time-boxed probes with different lifetimes should
//! not acquire a dependency on each other for a hundred lines; the first to be
//! archived would take the second with it.
//!
